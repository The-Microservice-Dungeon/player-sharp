...
namespace Player.Sharp.Consumers
{
    ...
    public class RobotDestroyedEventConsumer : DungeonEventConsumer<string, RobotDestroyedEvent>
    {
        ...
        public RobotDestroyedEventConsumer(IConfiguration config, ILogger<RobotDestroyedEventConsumer> logger, RobotService robotService) : base("robot-destroyed", config)
        {
            _logger = logger;
