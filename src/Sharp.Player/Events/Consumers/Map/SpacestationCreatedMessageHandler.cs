...
public class SpacestationCreatedMessageHandler : IMessageHandler<SpacestationCreatedEvent>
{
    ...
    public SpacestationCreatedMessageHandler(ILogger<SpacestationCreatedMessageHandler> logger, ICurrentMapStore mapStore, IMapManager mapManager)
    {
        _logger = logger;
        _mapStore = mapStore;
